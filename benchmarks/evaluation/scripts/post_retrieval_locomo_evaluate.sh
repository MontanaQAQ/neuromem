#!/bin/bash
# ============================================================================
# post_retrieval_locomo_evaluate.sh
#
# LoCoMo PostRetrieval实验评估脚本
# 自动发现并分析所有PostRetrieval_*目录
# ============================================================================
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo ""
            echo "示例:"
            echo "  $0                                               # 分析所有PostRetrieval_*目录"
            echo "  $0 --validate-only                               # 仅验证"
            echo "  $0 --path PostRetrieval_MemoryOS_forgetting_curve  # 分析指定目录"
            exit 0
            ;;
        *)
            echo "未知参数: $1"
