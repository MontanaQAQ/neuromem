...
#
# LoCoMo DataStructure实验评估脚本
# 自动发现并分析所有DataStructure_*目录
# ============================================================================
...
# 构建命令 - 指定独立的输出目录
OUTPUT_DIR=".sage/benchmarks/benchmark_memory/locomo/output/round_analysis_datastructure"
