#!/bin/bash
# 运行 Memory Data Structure 实验 - Feature Queue Summary Combination
# 使用方法: bash script/memory_data_structure/run_DataStructure_feature_queue_summary.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/memory_data_structure/locomo_feature_queue_summary_pipeline.yaml"
...
echo "========================================================================"
echo "Memory Data Structure 实验 - Feature Queue Summary Combination"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - DataStructure_feature_queue_summary"
