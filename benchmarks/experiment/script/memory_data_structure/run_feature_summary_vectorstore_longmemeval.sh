#!/bin/bash
# 运行 Memory Data Structure 实验 - Feature Summary Vectorstore Combination (Longmemeval)
...
CONFIG_FILE="$SCRIPT_DIR/../../config/memory_data_structure/longmemeval_feature_summary_vector_pipeline.yaml"
...
echo "========================================================================"
echo "Memory Data Structure 实验 - Feature Summary Vectorstore Combination (Longmemeval)"
echo "========================================================================"
echo ""
