#!/bin/bash
# 运行 Memory Data Structure 实验 - Feature Queue Segment Combination (Longmemeval)
...
CONFIG_FILE="$SCRIPT_DIR/../../config/memory_data_structure/longmemeval_feature_queue_segment_pipeline.yaml"
...
echo "========================================================================"
echo "Memory Data Structure 实验 - Feature Queue Segment Combination (Longmemeval)"
echo "========================================================================"
echo ""
