#!/bin/bash
# Run Memory Data Structure Experiment - Inverted Vectorstore Combination
# Dataset: Conflict Resolution (MemAgentBench)
# Usage: bash script/memory_data_structure/run_inverted_vectorstore_conflict_resolution.sh
...
# Config file path
CONFIG_FILE="$SCRIPT_DIR/../../config/memory_data_structure/conflict_resolution_inverted_vectorstore_pipeline.yaml"
...
MEMORY_NAME="DataStructure_inverted_vectorstore"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "Memory Data Structure Experiment - Inverted Vectorstore Combination"
...
echo "========================================================================"
echo "All tasks completed - DataStructure_inverted_vectorstore (Conflict Resolution)"
