#!/bin/bash
# 运行 Memory Data Structure 实验 - Semantic Inverted Knowledge Graph
# 使用方法: bash script/memory_data_structure/run_DataStructure_semantic_inverted_kg.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/memory_data_structure/locomo_semantic_kg_pipeline.yaml"
...
# 创建日志目录结构
DATASET="locomo"
MEMORY_NAME="DataStructure_semantic_inverted_kg"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "Memory Data Structure 实验 - Semantic Inverted Knowledge Graph"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - DataStructure_semantic_inverted_kg"
