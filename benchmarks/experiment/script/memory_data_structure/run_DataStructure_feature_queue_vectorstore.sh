#!/bin/bash
# 运行 Memory Data Structure 实验 - Feature Queue Vectorstore Combination
# 使用方法: bash script/memory_data_structure/run_DataStructure_feature_queue_vectorstore.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/memory_data_structure/locomo_feature_queue_vector_pipeline.yaml"
...
# 创建日志目录结构
DATASET="locomo"
MEMORY_NAME="DataStructure_feature_queue_vectorstore"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "Memory Data Structure 实验 - Feature Queue Vectorstore Combination"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - DataStructure_feature_queue_vectorstore"
