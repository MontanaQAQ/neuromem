#!/bin/bash
# 运行 Memory Data Structure 实验 - Linknote Graph (Longmemeval)
...
CONFIG_FILE="$SCRIPT_DIR/../../config/memory_data_structure/longmemeval_linknote_graph_pipeline.yaml"
...
echo "========================================================================"
echo "Memory Data Structure 实验 - Linknote Graph (Longmemeval)"
echo "========================================================================"
echo ""
