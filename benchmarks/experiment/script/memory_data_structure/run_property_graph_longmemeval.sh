#!/bin/bash
# 运行 Memory Data Structure 实验 - Property Graph (Longmemeval)
...
CONFIG_FILE="$SCRIPT_DIR/../../config/memory_data_structure/longmemeval_property_graph_pipeline.yaml"
...
echo "========================================================================"
echo "Memory Data Structure 实验 - Property Graph (Longmemeval)"
echo "========================================================================"
echo ""
