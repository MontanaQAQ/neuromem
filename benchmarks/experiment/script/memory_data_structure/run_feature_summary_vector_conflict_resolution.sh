#!/bin/bash
# Run Memory Data Structure Experiment - Feature Summary Vector Combination
# Dataset: Conflict Resolution (MemAgentBench)
# Usage: bash script/memory_data_structure/run_feature_summary_vector_conflict_resolution.sh
...
# Config file path
CONFIG_FILE="$SCRIPT_DIR/../../config/memory_data_structure/conflict_resolution_feature_summary_vector_pipeline.yaml"
...
MEMORY_NAME="DataStructure_feature_summary_vector"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "Memory Data Structure Experiment - Feature Summary Vector Combination"
...
echo "========================================================================"
echo "All tasks completed - DataStructure_feature_summary_vector (Conflict Resolution)"
