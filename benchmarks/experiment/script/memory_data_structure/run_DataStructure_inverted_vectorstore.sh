...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/memory_data_structure/locomo_inverted_vectorstore_pipeline.yaml"
...
echo "========================================================================"
echo "Memory Data Structure 实验 - Inverted Vectorstore Combination"
echo "========================================================================"
echo ""
