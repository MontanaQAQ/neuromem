#!/bin/bash
# 运行 Memory Data Structure 实验 - LSH Hash (Longmemeval)
...
CONFIG_FILE="$SCRIPT_DIR/../../config/memory_data_structure/longmemeval_lsh_hash_pipeline.yaml"
...
echo "========================================================================"
echo "Memory Data Structure 实验 - LSH Hash (Longmemeval)"
echo "========================================================================"
echo ""
