#!/bin/bash
# Run Mem0g Longmemeval PostRetrieval Experiment - multi_query
# Usage: bash script/context_integration_mechanism/run_mem0g_longmemeval_multi_query.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/Mem0g_longmemeval_multi_query_post_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "Mem0g Longmemeval PostRetrieval Experiment - multi_query"
echo "========================================================================"
