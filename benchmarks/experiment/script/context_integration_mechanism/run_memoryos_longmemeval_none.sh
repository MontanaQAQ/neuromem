#!/bin/bash
# Run MemoryOS Longmemeval PostRetrieval Experiment - none
# Usage: bash script/context_integration_mechanism/run_memoryos_longmemeval_none.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/MemoryOS_longmemeval_none_post_retrieval_pipeline.yaml"

TASK_IDS=("group-1" "group-2" "group-3")

DATASET="longmemeval"
MEMORY_NAME="PostRetrieval_MemoryOS_none"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "MemoryOS Longmemeval PostRetrieval Experiment - none"
echo "========================================================================"
...
echo "========================================================================"
echo "All tasks completed - post_retrieval_none_MemoryOS"
