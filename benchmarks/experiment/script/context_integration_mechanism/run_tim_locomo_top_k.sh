...
# Usage: bash script/context_integration_mechanism/run_tim_locomo_top_k.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/TiM_locomo_top_k_post_retrieval_pipeline.yaml"
