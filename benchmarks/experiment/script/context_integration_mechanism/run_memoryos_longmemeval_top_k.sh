#!/bin/bash
# Run MemoryOS Longmemeval PostRetrieval Experiment - top_k
# Usage: bash script/context_integration_mechanism/run_memoryos_longmemeval_top_k.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/MemoryOS_longmemeval_top_k_post_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "MemoryOS Longmemeval PostRetrieval Experiment - top_k"
echo "========================================================================"
...
echo "========================================================================"
echo "All tasks completed - post_retrieval_top_k_MemoryOS"
