#!/bin/bash
# Run MemoryOS Locomo PostRetrieve Experiment - augment (context integration)
# Usage: bash script/context_integration_mechanism/run_memoryos_locomo_augment.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/MemoryOS_locomo_augment_post_retrieval.yaml"
...
DATASET="locomo"
MEMORY_NAME="PostRetrieve_MemoryOS_augment"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "MemoryOS Locomo PostRetrieve Experiment - augment"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "All tasks completed - context_integration_augment_MemoryOS"
echo "========================================================================"
