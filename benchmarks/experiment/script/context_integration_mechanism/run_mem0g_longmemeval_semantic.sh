#!/bin/bash
# Run Mem0g Longmemeval PostRetrieval Experiment - semantic
# Usage: bash script/context_integration_mechanism/run_mem0g_longmemeval_semantic.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/Mem0g_longmemeval_semantic_post_retrieval_pipeline.yaml"

TASK_IDS=("group-1" "group-2" "group-3")

DATASET="longmemeval"
MEMORY_NAME="PostRetrieval_Mem0g_semantic"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "Mem0g Longmemeval PostRetrieval Experiment - semantic"
echo "========================================================================"
...
echo "========================================================================"
echo "All tasks completed - post_retrieval_semantic_Mem0g"
