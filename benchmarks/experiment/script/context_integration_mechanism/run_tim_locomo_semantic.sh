#!/bin/bash
# Run TiM Locomo PostRetrieval Experiment - semantic
# Usage: bash script/context_integration_mechanism/run_tim_locomo_semantic.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/TiM_locomo_semantic_post_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "TiM Locomo PostRetrieval Experiment - semantic"
echo "========================================================================"
echo ""
