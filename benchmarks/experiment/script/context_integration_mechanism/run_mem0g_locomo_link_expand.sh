#!/bin/bash
# Run Mem0g Locomo PostRetrieve Experiment - link_expand (context integration)
# Usage: bash script/context_integration_mechanism/run_mem0g_locomo_link_expand.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/Mem0g_locomo_link_expand_post_retrieval.yaml"
...
DATASET="locomo"
MEMORY_NAME="PostRetrieve_Mem0g_link_expand"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "Mem0g Locomo PostRetrieve Experiment - link_expand"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "All tasks completed - context_integration_link_expand_Mem0g"
echo "========================================================================"
