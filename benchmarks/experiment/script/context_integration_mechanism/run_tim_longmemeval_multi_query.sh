#!/bin/bash
# Run TiM Longmemeval PostRetrieval Experiment - multi_query
# Usage: bash script/context_integration_mechanism/run_tim_longmemeval_multi_query.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/TiM_longmemeval_multi_query_post_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "TiM Longmemeval PostRetrieval Experiment - multi_query"
echo "========================================================================"
