...
# Usage: bash script/context_integration_mechanism/run_memoryos_locomo_multi_query.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/MemoryOS_locomo_multi_query_post_retrieval_pipeline.yaml"
