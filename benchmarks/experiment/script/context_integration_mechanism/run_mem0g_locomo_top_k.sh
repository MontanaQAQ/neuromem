#!/bin/bash
# Run Mem0g Locomo PostRetrieval Experiment - top_k
# Usage: bash script/context_integration_mechanism/run_mem0g_locomo_top_k.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/Mem0g_locomo_top_k_post_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "Mem0g Locomo PostRetrieval Experiment - top_k"
echo "========================================================================"
echo ""
