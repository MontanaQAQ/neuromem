#!/bin/bash
# Run MemoryOS Locomo PostRetrieve Experiment - time_weighted (context integration)
# Usage: bash script/context_integration_mechanism/run_memoryos_locomo_time_weighted.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/MemoryOS_locomo_time_weighted_post_retrieval.yaml"
...
DATASET="locomo"
MEMORY_NAME="PostRetrieve_MemoryOS_time_weighted"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "MemoryOS Locomo PostRetrieve Experiment - time_weighted"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "All tasks completed - context_integration_time_weighted_MemoryOS"
echo "========================================================================"
