#!/bin/bash
# Run MemoryOS Locomo PostRetrieval Experiment - semantic
# Usage: bash script/context_integration_mechanism/run_memoryos_locomo_semantic.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/MemoryOS_locomo_semantic_post_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "MemoryOS Locomo PostRetrieval Experiment - semantic"
echo "========================================================================"
echo ""
