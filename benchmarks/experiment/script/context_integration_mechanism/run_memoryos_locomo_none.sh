#!/bin/bash
# Run MemoryOS Locomo PostRetrieve Experiment - none (context integration)
# Usage: bash script/context_integration_mechanism/run_memoryos_locomo_none.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/MemoryOS_locomo_none_post_retrieval_pipeline.yaml"
...
DATASET="locomo"
MEMORY_NAME="PostRetrieve_MemoryOS_none"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "MemoryOS Locomo PostRetrieve Experiment - none (context integration)"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "All tasks completed - context_integration_none_MemoryOS"
echo "========================================================================"
