#!/bin/bash
# Run MemoryOS Locomo PostRetrieval Experiment - top_k
# Usage: bash script/context_integration_mechanism/run_memoryos_locomo_top_k.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/MemoryOS_locomo_top_k_post_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "MemoryOS Locomo PostRetrieval Experiment - top_k"
echo "========================================================================"
echo ""
