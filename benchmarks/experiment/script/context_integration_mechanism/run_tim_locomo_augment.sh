#!/bin/bash
# Run TiM Locomo PostRetrieval Experiment - augment
# Usage: bash script/context_integration_mechanism/run_tim_locomo_augment.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/context_integration_mechanism/TiM_locomo_augment_post_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "TiM Locomo PostRetrieval Experiment - augment"
echo "========================================================================"
echo ""
