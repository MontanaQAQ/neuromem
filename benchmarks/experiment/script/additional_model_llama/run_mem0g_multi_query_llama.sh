#!/bin/bash
# 补充实验：Mem0g + Multi-query + Llama-3-8B
# 使用方法: bash benchmarks/experiment/script/additional_model_llama/run_mem0g_multi_query_llama.sh
...
# 配置文件路径
CONFIG_FILE="$PROJECT_ROOT/benchmarks/experiment/config/additional_experiments_ds_llama/llama_context_integration_mechanism/Mem0g_locomo_multi_query_post_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "补充实验: Mem0g + Multi-query + Llama-3-8B"
echo "========================================================================"
echo ""
