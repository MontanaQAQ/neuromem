...
# Usage: bash script/post_retrieval_strategy/run_mem0g_locomo_none.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/post_retrieval_strategy/Mem0g_locomo_none_post_retrieval_pipeline.yaml"
...
DATASET="locomo"
MEMORY_NAME="post_retrieval_none_Mem0g"
