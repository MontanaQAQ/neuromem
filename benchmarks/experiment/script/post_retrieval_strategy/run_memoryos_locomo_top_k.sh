...
# Usage: bash script/post_retrieval_strategy/run_memoryos_locomo_top_k.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/post_retrieval_strategy/MemoryOS_locomo_top_k_post_retrieval_pipeline.yaml"
