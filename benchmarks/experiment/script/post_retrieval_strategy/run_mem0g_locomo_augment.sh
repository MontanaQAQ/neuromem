...
# Usage: bash script/post_retrieval_strategy/run_mem0g_locomo_augment.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/post_retrieval_strategy/Mem0g_locomo_augment_post_retrieval_pipeline.yaml"
...
DATASET="locomo"
MEMORY_NAME="post_retrieval_augment_Mem0g"
