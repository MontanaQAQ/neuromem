#!/bin/bash
# Run TiM Locomo PostRetrieval Experiment - top_k
# Usage: bash script/post_retrieval_strategy/run_tim_locomo_top_k.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/post_retrieval_strategy/TiM_locomo_top_k_post_retrieval_pipeline.yaml"
