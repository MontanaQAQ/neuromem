...
# Usage: bash script/post_retrieval_strategy/run_mem0g_locomo_top_k.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/post_retrieval_strategy/Mem0g_locomo_top_k_post_retrieval_pipeline.yaml"
...
DATASET="locomo"
MEMORY_NAME="post_retrieval_top_k_Mem0g"
