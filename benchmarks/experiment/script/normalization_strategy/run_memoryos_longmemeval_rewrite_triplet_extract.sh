#!/bin/bash
# 运行 Normalization Strategy - MemoryOS rewrite_triplet_extract pre_insert (longmemeval)
...
CONFIG_FILE="$SCRIPT_DIR/../../config/normalization_strategy/MemoryOS_longmemeval_rewrite_triplet_extract_pre_insert_pipeline.yaml"
...
echo "========================================================================"
echo "Normalization Strategy: MemoryOS rewrite_triplet_extract pre_insert (longmemeval)"
echo "========================================================================"
echo ""
