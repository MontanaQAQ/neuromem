#!/bin/bash
# 运行 Normalization Strategy - Mem0g none pre_insert
# 使用方法: bash script/normalization_strategy/run_Mem0g_locomo_none_pre_insert_pipeline.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/normalization_strategy/Mem0g_locomo_none_pre_insert_pipeline.yaml"
