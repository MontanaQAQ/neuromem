#!/bin/bash
# 运行 Normalization Strategy - MemoryOS score_importance pre_insert
# 使用方法: bash script/normalization_strategy/run_MemoryOS_locomo_score_importance_pre_insert_pipeline.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/normalization_strategy/MemoryOS_locomo_score_importance_pre_insert_pipeline.yaml"
...
DATASET="locomo"
DATE=$(date +%Y%m%d)
MEMORY_NAME="MemoryOS-score-importance"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$DATE/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "Normalization Strategy: MemoryOS score_importance pre_insert"
echo "========================================================================"
echo ""
