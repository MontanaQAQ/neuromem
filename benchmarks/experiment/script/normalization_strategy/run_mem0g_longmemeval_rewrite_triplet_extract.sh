#!/bin/bash
# 运行 Normalization Strategy - Mem0g rewrite_triplet_extract pre_insert (longmemeval)
...
CONFIG_FILE="$SCRIPT_DIR/../../config/normalization_strategy/Mem0g_longmemeval_rewrite_triplet_extract_pre_insert_pipeline.yaml"
...
echo "========================================================================"
echo "Normalization Strategy: Mem0g rewrite_triplet_extract pre_insert (longmemeval)"
echo "========================================================================"
echo ""
