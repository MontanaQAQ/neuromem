#!/bin/bash
# 运行 Normalization Strategy - MemoryOS score_heat pre_insert
# 使用方法: bash script/normalization_strategy/run_MemoryOS_locomo_score_heat_pre_insert_pipeline.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/normalization_strategy/MemoryOS_locomo_score_heat_pre_insert_pipeline.yaml"
