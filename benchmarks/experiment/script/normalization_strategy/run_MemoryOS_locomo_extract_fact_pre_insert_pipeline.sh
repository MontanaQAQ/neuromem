#!/bin/bash
# 运行 Normalization Strategy - MemoryOS extract_fact pre_insert
# 使用方法: bash script/normalization_strategy/run_MemoryOS_locomo_extract_fact_pre_insert_pipeline.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/normalization_strategy/MemoryOS_locomo_extract_fact_pre_insert_pipeline.yaml"
