#!/bin/bash
# 运行 Normalization Strategy - Mem0g none pre_insert (longmemeval)
...
CONFIG_FILE="$SCRIPT_DIR/../../config/normalization_strategy/Mem0g_longmemeval_none_pre_insert_pipeline.yaml"
...
echo "========================================================================"
echo "Normalization Strategy: Mem0g none pre_insert (longmemeval)"
echo "========================================================================"
echo ""
