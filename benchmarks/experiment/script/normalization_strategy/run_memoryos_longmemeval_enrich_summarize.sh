#!/bin/bash
# 运行 Normalization Strategy - MemoryOS enrich_summarize pre_insert (longmemeval)
...
CONFIG_FILE="$SCRIPT_DIR/../../config/normalization_strategy/MemoryOS_longmemeval_enrich_summarize_pre_insert_pipeline.yaml"
...
echo "========================================================================"
echo "Normalization Strategy: MemoryOS enrich_summarize pre_insert (longmemeval)"
echo "========================================================================"
echo ""
