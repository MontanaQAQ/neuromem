#!/bin/bash
# 运行 Normalization Strategy - MemoryOS none pre_insert
# 使用方法: bash script/normalization_strategy/run_MemoryOS_locomo_none_pre_insert_pipeline.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/normalization_strategy/MemoryOS_locomo_none_pre_insert_pipeline.yaml"
