#!/bin/bash
# 补充实验：Mem0g + None + e5-large-v2 embedding
# 使用方法: bash benchmarks/experiment/script/additional_embedding/run_mem0g_none_e5_large.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/additional_embedding/Mem0g_locomo_none_e5_large.yaml"
