#!/bin/bash
# 运行 Longmemeval 长轮对话记忆实验 - Mem0g (Graph) 批量测试
...
CONFIG_FILE="$SCRIPT_DIR/../../config/primitive_memory_model/longmemeval_mem0g_pipeline.yaml"
...
echo "Longmemeval - Mem0g (Graph) 批量测试"
