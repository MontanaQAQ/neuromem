#!/bin/bash
# 运行 Longmemeval 长轮对话记忆实验 - HippoRAG2 批量测试
...
CONFIG_FILE="$SCRIPT_DIR/../../config/primitive_memory_model/longmemeval_hipporag2_pipeline.yaml"
...
echo "Longmemeval - HippoRAG2 批量测试"
