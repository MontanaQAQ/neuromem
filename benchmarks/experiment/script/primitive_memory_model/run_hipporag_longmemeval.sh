#!/bin/bash
# 运行 Longmemeval 长轮对话记忆实验 - HippoRAG 批量测试
...
CONFIG_FILE="$SCRIPT_DIR/../../config/primitive_memory_model/longmemeval_hipporag_pipeline.yaml"
...
echo "Longmemeval - HippoRAG 批量测试"
