#!/bin/bash
# 运行 Longmemeval 长轮对话记忆实验 - STM 批量测试
...
CONFIG_FILE="$SCRIPT_DIR/../../config/primitive_memory_model/longmemeval_short_term_memory_pipeline.yaml"
