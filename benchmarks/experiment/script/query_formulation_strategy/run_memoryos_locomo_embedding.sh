#!/bin/bash
# 运行 MemoryOS Locomo PreRetrieval 实验 - embedding
# 使用方法: bash script/query_formulation_strategy/run_memoryos_locomo_embedding.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/query_formulation_strategy/MemoryOS_locomo_embedding_pre_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "MemoryOS Locomo PreRetrieval 实验 - embedding"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - MemoryOS-embedding"
