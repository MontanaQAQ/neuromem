#!/bin/bash
# 运行 MemoryOS Longmemeval PreRetrieval 实验 - validate
# 使用方法: bash script/query_formulation_strategy/run_memoryos_longmemeval_validate.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/query_formulation_strategy/MemoryOS_longmemeval_validate_pre_retrieval_pipeline.yaml"
...
DATASET="longmemeval"
MEMORY_NAME="PreRetrieval_MemoryOS_validate"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "MemoryOS Longmemeval PreRetrieval 实验 - validate"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - MemoryOS-validate (longmemeval)"
