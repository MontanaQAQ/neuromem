#!/bin/bash
# 运行 Mem0g Longmemeval PreRetrieval 实验 - validate
# 使用方法: bash script/query_formulation_strategy/run_mem0g_longmemeval_validate.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/query_formulation_strategy/Mem0g_longmemeval_validate_pre_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - Mem0g-validate (longmemeval)"
