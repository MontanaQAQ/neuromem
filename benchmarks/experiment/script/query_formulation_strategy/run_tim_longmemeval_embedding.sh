#!/bin/bash
# 运行 TiM Longmemeval PreRetrieval 实验 - embedding
# 使用方法: bash script/query_formulation_strategy/run_tim_longmemeval_embedding.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/query_formulation_strategy/TiM_longmemeval_embedding_pre_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - TiM-embedding (longmemeval)"
