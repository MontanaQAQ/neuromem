#!/bin/bash
# 运行 MemoryOS Locomo PreRetrieval 实验 - decompose
# 使用方法: bash script/query_formulation_strategy/run_memoryos_locomo_decompose.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/query_formulation_strategy/MemoryOS_locomo_decompose_pre_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "MemoryOS Locomo PreRetrieval 实验 - decompose"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - MemoryOS-decompose"
