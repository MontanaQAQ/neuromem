#!/bin/bash
# 运行 TiM Longmemeval PreRetrieval 实验 - keyword_extract
# 使用方法: bash script/query_formulation_strategy/run_tim_longmemeval_keyword_extract.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/query_formulation_strategy/TiM_longmemeval_keyword_extract_pre_retrieval_pipeline.yaml"
...
DATASET="longmemeval"
MEMORY_NAME="PreRetrieval_TiM_keyword_extract"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "TiM Longmemeval PreRetrieval 实验 - keyword_extract"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - TiM-keyword_extract (longmemeval)"
