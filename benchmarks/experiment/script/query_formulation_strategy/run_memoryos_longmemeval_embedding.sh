#!/bin/bash
# 运行 MemoryOS Longmemeval PreRetrieval 实验 - embedding
# 使用方法: bash script/query_formulation_strategy/run_memoryos_longmemeval_embedding.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/query_formulation_strategy/MemoryOS_longmemeval_embedding_pre_retrieval_pipeline.yaml"
...
DATASET="longmemeval"
MEMORY_NAME="PreRetrieval_MemoryOS_embedding"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "MemoryOS Longmemeval PreRetrieval 实验 - embedding"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - MemoryOS-embedding (longmemeval)"
