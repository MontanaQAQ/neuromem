#!/bin/bash
# 运行 Mem0g Longmemeval PreRetrieval 实验 - keyword_extract
# 使用方法: bash script/query_formulation_strategy/run_mem0g_longmemeval_keyword_extract.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/query_formulation_strategy/Mem0g_longmemeval_keyword_extract_pre_retrieval_pipeline.yaml"
...
DATASET="longmemeval"
MEMORY_NAME="PreRetrieval_Mem0g_keyword_extract"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "Mem0g Longmemeval PreRetrieval 实验 - keyword_extract"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - Mem0g-keyword_extract (longmemeval)"
