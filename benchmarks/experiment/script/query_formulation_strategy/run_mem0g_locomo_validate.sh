#!/bin/bash
# 运行 Mem0g Locomo PreRetrieval 实验 - validate
# 使用方法: bash script/query_formulation_strategy/run_mem0g_locomo_validate.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/query_formulation_strategy/Mem0g_locomo_validate_pre_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "Mem0g Locomo PreRetrieval 实验 - validate"
echo "========================================================================"
echo ""
