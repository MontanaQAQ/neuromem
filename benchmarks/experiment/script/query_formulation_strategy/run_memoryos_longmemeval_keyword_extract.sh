#!/bin/bash
# 运行 MemoryOS Longmemeval PreRetrieval 实验 - keyword_extract
# 使用方法: bash script/query_formulation_strategy/run_memoryos_longmemeval_keyword_extract.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/query_formulation_strategy/MemoryOS_longmemeval_keyword_extract_pre_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "MemoryOS Longmemeval PreRetrieval 实验 - keyword_extract"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - MemoryOS-keyword_extract (longmemeval)"
