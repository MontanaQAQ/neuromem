#!/bin/bash
# 运行 TiM PostInsert 实验 - none (baseline)
# 使用方法: bash script/consolidation_policy/run_tim_locomo_none.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/consolidation_policy/TiM_locomo_none_post_insert_pipeline.yaml"
...
echo "========================================================================"
echo "TiM PostInsert 实验 - none (baseline)"
echo "========================================================================"
echo ""
