#!/bin/bash
# 运行 TiM PostInsert 实验 - none (baseline) on longmemeval
# 使用方法: bash script/consolidation_policy/run_tim_longmemeval_none.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/consolidation_policy/TiM_longmemeval_none_post_insert_pipeline.yaml"
