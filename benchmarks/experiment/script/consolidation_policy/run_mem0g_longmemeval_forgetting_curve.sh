#!/bin/bash
# 运行 Mem0g PostInsert 实验 - forgetting_curve on longmemeval
# 使用方法: bash script/consolidation_policy/run_mem0g_longmemeval_forgetting_curve.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/consolidation_policy/Mem0g_longmemeval_forgetting_curve_post_insert_pipeline.yaml"
...
DATASET="longmemeval"
MEMORY_NAME="PostInsert_Mem0g_forgetting_curve"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "Mem0g PostInsert 实验 - forgetting_curve [longmemeval]"
echo "========================================================================"
echo ""
