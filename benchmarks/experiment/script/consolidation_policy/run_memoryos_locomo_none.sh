#!/bin/bash
# 运行 MemoryOS PostInsert 实验 - none (baseline)
# 使用方法: bash script/consolidation_policy/run_memoryos_locomo_none.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/consolidation_policy/MemoryOS_locomo_none_post_insert_pipeline.yaml"
...
echo "========================================================================"
echo "MemoryOS PostInsert 实验 - none (baseline)"
echo "========================================================================"
echo ""
