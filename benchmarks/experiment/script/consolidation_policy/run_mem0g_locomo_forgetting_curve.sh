#!/bin/bash
# 运行 Mem0g PostInsert 实验 - forgetting_curve
# 使用方法: bash script/consolidation_policy/run_mem0g_locomo_forgetting_curve.sh
...
echo "========================================================================"
echo "Mem0g PostInsert 实验 - forgetting_curve"
echo "========================================================================"
echo ""
