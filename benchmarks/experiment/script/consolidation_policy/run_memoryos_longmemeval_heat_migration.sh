#!/bin/bash
# 运行 MemoryOS PostInsert 实验 - heat_migration on longmemeval
# 使用方法: bash script/consolidation_policy/run_memoryos_longmemeval_heat_migration.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/consolidation_policy/MemoryOS_longmemeval_heat_migration_post_insert_pipeline.yaml"
...
DATASET="longmemeval"
MEMORY_NAME="PostInsert_MemoryOS_heat_migration"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "MemoryOS PostInsert 实验 - heat_migration [longmemeval]"
echo "========================================================================"
echo ""
