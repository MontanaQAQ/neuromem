#!/bin/bash
# 运行 Mem0g PostInsert 实验 - none (baseline) on longmemeval
# 使用方法: bash script/consolidation_policy/run_mem0g_longmemeval_none.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/consolidation_policy/Mem0g_longmemeval_none_post_insert_pipeline.yaml"
