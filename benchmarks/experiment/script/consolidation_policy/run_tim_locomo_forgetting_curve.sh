#!/bin/bash
# 运行 TiM PostInsert 实验 - forgetting_curve
# 使用方法: bash script/consolidation_policy/run_tim_locomo_forgetting_curve.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/consolidation_policy/TiM_locomo_forgetting_curve_post_insert_pipeline.yaml"
...
echo "========================================================================"
echo "TiM PostInsert 实验 - forgetting_curve"
echo "========================================================================"
echo ""
