#!/bin/bash
# 运行 Mem0g PostInsert 实验 - link_evolution on longmemeval
# 使用方法: bash script/consolidation_policy/run_mem0g_longmemeval_link_evolution.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/consolidation_policy/Mem0g_longmemeval_link_evolution_post_insert_pipeline.yaml"
...
echo "========================================================================"
echo "Mem0g PostInsert 实验 - link_evolution [longmemeval]"
echo "========================================================================"
echo ""
