#!/bin/bash
# 运行 TiM PostInsert 实验 - llm_crud
# 使用方法: bash script/consolidation_policy/run_tim_locomo_llm_crud.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/consolidation_policy/TiM_locomo_llm_crud_post_insert_pipeline.yaml"
...
echo "========================================================================"
echo "TiM PostInsert 实验 - llm_crud"
echo "========================================================================"
echo ""
