#!/bin/bash
# 运行 MemoryOS PostInsert 实验 - heat_migration (专属策略)
# 使用方法: bash script/consolidation_policy/run_memoryos_locomo_heat_migration.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/consolidation_policy/MemoryOS_locomo_heat_migration_post_insert_pipeline.yaml"
...
echo "========================================================================"
echo "MemoryOS PostInsert 实验 - heat_migration (专属策略)"
echo "========================================================================"
echo ""
