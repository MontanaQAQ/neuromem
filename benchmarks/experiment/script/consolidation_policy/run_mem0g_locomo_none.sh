#!/bin/bash
# 运行 Mem0g PostInsert 实验 - none (baseline)
# 使用方法: bash script/consolidation_policy/run_mem0g_locomo_none.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/consolidation_policy/Mem0g_locomo_none_post_insert_pipeline.yaml"
...
echo "========================================================================"
echo "Mem0g PostInsert 实验 - none (baseline)"
echo "========================================================================"
echo ""
