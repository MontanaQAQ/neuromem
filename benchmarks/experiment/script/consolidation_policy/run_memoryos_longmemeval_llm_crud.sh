#!/bin/bash
# 运行 MemoryOS PostInsert 实验 - llm_crud on longmemeval
# 使用方法: bash script/consolidation_policy/run_memoryos_longmemeval_llm_crud.sh
...
CONFIG_FILE="$SCRIPT_DIR/../../config/consolidation_policy/MemoryOS_longmemeval_llm_crud_post_insert_pipeline.yaml"
