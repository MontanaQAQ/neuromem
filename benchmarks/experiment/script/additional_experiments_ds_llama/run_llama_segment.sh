#!/bin/bash
# 运行 Llama-3.1-8B 补充实验 - Segment
# 使用方法: bash script/additional_experiments_ds_llama/run_llama_segment.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/additional_experiments_ds_llama/llama_segment_pipeline.yaml"
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - Llama_DataStructure_segment"
echo "========================================================================"
