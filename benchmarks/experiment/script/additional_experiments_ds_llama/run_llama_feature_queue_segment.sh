#!/bin/bash
# 运行 Llama-3.1-8B 补充实验 - Feature Queue Segment
# 使用方法: bash script/additional_experiments_ds_llama/run_llama_feature_queue_segment.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/additional_experiments_ds_llama/llama_feature_queue_segment_pipeline.yaml"
...
# 创建日志目录结构
DATASET="locomo"
MEMORY_NAME="Llama_DataStructure_feature_queue_segment"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "Llama-3.1-8B 补充实验 - Feature Queue Segment"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - Llama_DataStructure_feature_queue_segment"
echo "========================================================================"
