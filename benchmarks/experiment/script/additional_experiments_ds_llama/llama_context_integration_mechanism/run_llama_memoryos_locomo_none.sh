#!/bin/bash
# Llama Run - MemoryOS Locomo PostRetrieval - none

set -e
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/../../../../.." && pwd)"
PYTHON_SCRIPT="$SCRIPT_DIR/../../../memory_test_pipeline.py"
CONFIG_FILE="$SCRIPT_DIR/../../../config/additional_experiments_ds_llama/llama_context_integration_mechanism/MemoryOS_locomo_none_post_retrieval_pipeline.yaml"
...
DATASET="locomo"
MEMORY_NAME="PostRetrieval_MemoryOS_none_Llama"
