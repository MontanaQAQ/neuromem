#!/bin/bash
# Llama Run - Mem0g Locomo PostRetrieval - semantic

set -e
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/../../../../.." && pwd)"
PYTHON_SCRIPT="$SCRIPT_DIR/../../../memory_test_pipeline.py"
CONFIG_FILE="$SCRIPT_DIR/../../../config/additional_experiments_ds_llama/llama_context_integration_mechanism/Mem0g_locomo_semantic_post_retrieval_pipeline.yaml"
...
DATASET="locomo"
MEMORY_NAME="PostRetrieval_Mem0g_semantic_Llama"
