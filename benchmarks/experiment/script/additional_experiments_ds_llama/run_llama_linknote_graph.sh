#!/bin/bash
# 运行 Llama-3.1-8B 补充实验 - Linknote Graph
# 使用方法: bash script/additional_experiments_ds_llama/run_llama_linknote_graph.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/additional_experiments_ds_llama/llama_linknote_graph_pipeline.yaml"
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - Llama_DataStructure_linknote_graph"
echo "========================================================================"
