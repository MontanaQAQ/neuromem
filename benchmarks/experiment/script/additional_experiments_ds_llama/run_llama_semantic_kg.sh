#!/bin/bash
# 运行 Llama-3.1-8B 补充实验 - Semantic Inverted Knowledge Graph
# 使用方法: bash script/additional_experiments_ds_llama/run_llama_semantic_kg.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/additional_experiments_ds_llama/llama_semantic_kg_pipeline.yaml"
...
# 创建日志目录结构
DATASET="locomo"
MEMORY_NAME="Llama_DataStructure_semantic_inverted_kg"
LOG_BASE_DIR="$PROJECT_ROOT/.sage/output/benchmarks/benchmark_memory/$DATASET/$MEMORY_NAME"
mkdir -p "$LOG_BASE_DIR"

echo "========================================================================"
echo "Llama-3.1-8B 补充实验 - Semantic Inverted Knowledge Graph"
echo "========================================================================"
echo ""
...
echo "========================================================================"
echo "🎉 所有任务执行完毕 - Llama_DataStructure_semantic_inverted_kg"
echo "========================================================================"
